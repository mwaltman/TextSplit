    ...
    public class AutoUpdater
    {
        ...
        public bool CheckForUpdate() {
            try {
                ...
                Globals.WriteToLogFile("Failed to check for updates.");
                return false;
            }
        }
        ...
        public bool DeletePreviousUpdateFiles() {
            ...
            if (currentProgramDirectory.Substring(currentProgramDirectory.LastIndexOf(@"\")).Equals(UpgradeFolderName)) {
                ...
                try {
                    ...
                    Globals.WriteToLogFile("Failed to remove upgrade folder.");
                }
                ...
                while (retry) {
                    ...
                    if (Directory.Exists(tempDirectory)) {
                        ...
                        try {
                            ...
                            Globals.WriteToLogFile("Failed to upgrade TextSplit. The files could not be downloaded.");
        ...
        public void ImportSettingsFromTxtFile(string filename) {
            try {
                ...
                Globals.WriteToLogFile("Failed to import settings from previous version");
            }
        }
    }
}
